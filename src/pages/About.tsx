...
export default function About() {
  ...
  const globalAmbassadorsOtherCountries = [
    ...
    },
    {
      ...
      role: 'Global Ambassador - India',
      bio: 'நாடறிந்த எழுத்தாளர், கவிஞர், நாடகாசிரியர், நாவலாசிரியர், சமூக ஆர்வலர், பேச்சாளர், பத்திரிகை எழுத்தாளர் எனப் பல்வேறு பரிமாணங்களில் திகழும் கலைமாமணி ஏர்வாடி எஸ். இராதாகிருஷ்ணன் 100-க்கும் மேற்பட்ட நூல்களை எழுதியுள்ளார். தமிழ்நாடு அரசின் சிறந்த நூல்களுக்கான பரிசுகள் பெற்றவர். அவரின் முதல் கவிதை பள்ளிப் பாடப்புத்தகமாக அமைந்தது என்பது குறிப்பிடத்தக்கது. தமிழ்நாடு அரசின் கலைமாமணி  விருது, இந்தியா மட்டுமின்றி உலகம் முழுவதும் பல விருதுகள் பெற்று அமெரிக்கா, இங்கிலாந்து, பிரான்ஸ், மேற்கு ஜெர்மனி, கிரீஸ், இத்தாலி, கனடா, இலங்கை, சிங்கப்பூர், மலேசியா, தாய்லாந்து போன்ற உலக நாடுகளுக்கு இலக்கியப் பயணம் சென்று வந்தவர். அவர் ஆசிரியராகவும், வெளிப்படையான விமர்சகராகவும், கவிதை உரை நிகழ்ச்சிகளின் மூலம் இலக்கிய உலகில் முக்கிய இடத்தைப் பெற்றவர். அவரது வாழ்க்கை, எழுத்து, சமூக பங்களிப்பு ஆகியவை இளைஞர்கள் மத்தியில் பெரும் தாக்கத்தை ஏற்படுத்துகின்றன, <strong>Thamizh Nadu, India </strong>',
