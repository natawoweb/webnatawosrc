...
export default function About() {
  ...
  const globalAmbassadorsOtherCountries = [
    ...
    {
      name: 'Mr. Poulaven Cheenaramen, M.A., (Ph.D)',
      role: 'Global Ambassador - Mauritius',
      bio: 'இலக்கியவாதி, தமிழ்க் கல்வியாளர், எழுத்தாளர் எனப் பல பரிமாணங்களில் திகழ்பவர். மொரீசியசு தீவில் வெளிவந்த முதல் தமிழ் மொழிச் சிறுவர் கதை நூல் ‘இயற்கை நண்பன்’ என்ற படைப்பின் ஆசிரியர். தமிழ் மொழியின் வளர்ச்சியை நோக்கமாகக் கொண்டு, அந்த நூலை ஆயிரத்துக்கும் மேற்பட்ட மாணவர்களுக்கு இலவசமாக வழங்கியவர் என்பது குறிப்பிடத்தக்கது. தமிழ் மொழி வளர்ச்சிக்கான தனது அயராத முயற்சியின் ஒரு பகுதியாக, தமிழ் இலக்கியம், இலக்கணம் மற்றும் மொரீசியசு நாட்டின் வரலாறு ஆகியவற்றை மையமாகக் கொண்டு தமிழில் நூல்கள் வெளியிடும் பணியில் தொடர்ந்து ஈடுபட்டு வருகிறார்., <strong>L’Escalier, Mauritius</strong>',
      image: '/lovable-uploads/31.jpeg',
    },
  ];
